//
//  FavoriteFoodScreenInteractor.swift
//  GraduationProject
//
...
class FavoriteFoodScreenInteractor: PresenterToInteractorFavoriteFoodScreenProtocol {
    
    //var favoriteFoodScreenPresenter: InteractorToPresenterFavoriteFoodScreenProtocol?
