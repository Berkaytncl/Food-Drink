//
//  WatchDeliveryScreenInteractor.swift
//  GraduationProject
//
...
class WatchDeliveryScreenInteractor: PresenterToInteractorWatchDeliveryScreenProtocol {
    
    //var watchDeliveryScreenPresenter: InteractorToPresenterWatchDeliveryScreenProtocol?
